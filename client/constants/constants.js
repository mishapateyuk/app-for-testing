...
export const testPreviewInfoIsLoaded = 'TEST_PREVIEW_INFO_IS_LOADED';
export const clearTestPreviewInfo = 'CLEAR_TEST_PREVIEW_INFO';
...
export const setInitialQuestionId = 'SET_INITIAL_QUESTION_ID';
export const changeQuestionId = 'CHANGE_QUESTION_ID';
